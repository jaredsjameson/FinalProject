...
### Techniques for Analysis: Topic Modelling
...
OWS_Benjamin_full.length.agg.range
...
OWS_Benjamin_full.single.termfreq
```
...
OWS_Benjamin_full.single.termfreq.filtered <- OWS_Benjamin_full.single.termfreq %>%
  filter(n > 1)
OWS_Benjamin_full.single.termfreq.filtered
...
OWS_Benjamin_full.single.termfreq.filtered.parlengroup
...
OWS_Benjamin_full.single.termfreq.filtered.stackedgroups1
...
OWS_Benjamin_full.single.termfreq.filtered.stackedreadywhole

OWS_Benjamin_full.single.termfreq.stackedbgraph <- 
  ggplot(data = OWS_Benjamin_full.single.termfreq.filtered.stackedreadywhole, aes(x = StackedClass, y = term_freq, fill = word)) +
