...
Through this reading several interesting things came to light, the most interesting of which being the connections between the term street, one central to the book, to the ideas of dreaming and waking. While dreaming and waking as themes are apparent just throgh reading *One-Way Street* it doesn't seem as prominent when reading as it actually is in the text according to this analysis. In addition, the word passed, being strongly related to both street and wake, is more compelling here than may initially seem, as *The Arcades Project*, in German, translates to *Das Passagen-Werk*, and the idea of passage, features prominently in that text. This could be the thread that really strings those two books together thematically, the idea of the passage.

All in all, through this work, I was able to anwer the questions of what Benjamin's defining structural preferences and stylistic techniques for his aphoristic writing, which is useful for understanding the author as a writer as well as the writing itself. In addition, this analysis offered answers as to how the themes between *One-Way Street* and Benjamin's other texts intersect, and by looking at the text this way, it became apparent that there were various other analytic angles to deepen the interpretation being built. 
